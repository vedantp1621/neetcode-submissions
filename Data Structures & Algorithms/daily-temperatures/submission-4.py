class Solution:
    def dailyTemperatures(self, temperatures: List[int]) -> List[int]:
        ...
        result = [0] * len(temperatures) # store res values
        stack = [] # stores [temp, index] -> we are storing the 
...
# use a stack because we are looking retrospectively, but counting forward by how many backspaces we need
